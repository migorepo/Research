...
namespace Wp8.Framework.Utils.Utils
{
    public static class EnumerableExtensions
    {
        ...
        public static T MinObject<T, TU>(this IEnumerable<T> list, Func<T, TU> selector)
            where T : class
            where TU : IComparable
        {
            TU resultValue = default(TU);
            T result = null;
        ...
        public static T MaxObject<T, TU>(this IEnumerable<T> list, Func<T, TU> selector)
            where T : class
            where TU : IComparable
        {
            TU resultValue = default(TU);
